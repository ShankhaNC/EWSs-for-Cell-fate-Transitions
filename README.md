...
(3) Use the Detrending_Code.R code to detrend that trajectory using Gaussian kernel smoothing, LOESS filtering, first differencing or linear detrending as you wish.
