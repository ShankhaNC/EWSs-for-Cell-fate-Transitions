classdef Violin < handle
    ...
    methods
        function obj = Violin(data, pos, varargin)
            ...
            obj.ScatterPlot = ...
                scatter(pos + jitter.*jitterstrength, data, 'filled','ko');
    ...
    methods (Access=private)
        function results = checkInputs(obj, data, pos, varargin)
            ...
            p.addParameter('BoxColor', [0 0 1], iscolor);
            p.addParameter('BoxWidth', 0.05, isscalarnumber);
            p.addParameter('EdgeColor', [0 0 0], iscolor);
            p.addParameter('MedianColor', [1 1 1], iscolor);
            p.addParameter('ViolinAlpha', 0.5, isscalarnumber);
